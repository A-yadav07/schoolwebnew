...
const BlogPosts = () => {
  ...
  const featuredPost = {
    ...
    excerpt:
             " Discover insightful articles, student stories, and campus highlights Stay updated with the best from our school community",
    authorImage:
    ...
    <div className="min-h-screen bg-gray-50">
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mt-12">
         <Link to="/allblog">
          <button className="bg-blue-900 hover:bg-blue-800 text-white px-8 py-3 rounded-full font-medium transition duration-300 cursor-pointer whitespace-nowrap !rounded-button">
            Load More Articles
          </button>
          </Link>
        </div>
